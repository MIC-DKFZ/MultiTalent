...
from multitalent.evaluation.surface_dice import normalized_surface_dice
    ...
    for r in labels_or_regions:
        try:
            ...
            if tp + fp + fn == 0:
                ...
                results['metrics'][r]['NSD'] = normalized_surface_dice(mask_ref, mask_pred)
        except Exception as e:
            print(f'Error in files {reference_file} and {prediction_file}')
            raise e
    return results
...
def compute_metrics_on_folder(folder_ref: str, folder_pred: str, output_file: str,
    ...
    print('foreground_mean', result['foreground_mean']['Dice'] )
    if output_file is not None:
...
if __name__ == '__main__':
    folder_ref = '/home/constantin/cluster-data_all/c306h/bpregtotalpred/totalseg_tst/labelsTs/sitk'
    folder_pred = '/home/constantin/cluster-data/bpregtotalpred/Dataset009_Spleen/nnUNetTrainer__nnUNetPlans__3d_fullres'
    output_file = '/home/constantin/cluster-data/bpregtotalpred/Dataset009_Spleen/nnUNetTrainer__nnUNetPlans__3d_fullres/summary.json'
