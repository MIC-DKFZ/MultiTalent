...
from multitalent.training.loss.focal_loss_2 import FocalLoss, MULTICLASS_MODE, MULTILABEL_MODE
from multitalent.training.loss.focal_loss_3 import FocalLossJunMa11
