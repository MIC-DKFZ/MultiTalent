...
def convert_brats(taskname: str, basedir: str, nnunet_dataset_id: int,):
    ...
    for patient in os.listdir(basedir):
        if patient.startswith('BraTS-GoAT'):
            count +=1
    ...
    generate_dataset_json(out_base, {"0": "T1", "1": "T1ce", "2": "T2", "3": "Flair"},
                          ...
                          dataset_name=task_name, reference='brats24_task2_Africa',
                          release='release',
...
inpath = '/home/constantin/E132-Projekte/Projects/2024_Ulrich_beyond_brats/MICCAI2024-BraTS-GoAT-TrainingData-With-GroundTruth/MICCAI2024-BraTS-GoAT-TrainingData-With-GroundTruth/'
taskname = 'brats24_task2_Africa'
convert_brats(taskname, inpath, 406)