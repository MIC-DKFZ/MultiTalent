...
from multitalent.utilities.utils import get_identifiers_from_splitted_dataset_folder, \
...
def generate_overlay(input_image: np.ndarray, segmentation: np.ndarray, mapping: dict = None,
    ...
    if mapping is None:
        ...
        # print(uniques)# np.unique(segmentation)

        mapping = {i: int(i) for c, i in enumerate(uniques)}
