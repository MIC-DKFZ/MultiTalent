...
from multitalent.experiment_planning.experiment_planners.network_topology import get_pool_and_conv_props
...
from multitalent.preprocessing.resampling.default_resampling import resample_data_or_seg_to_shape, compute_new_shape
...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        if not isfile(join(preprocessed_folder, 'dataset_fingerprint.json')):
            raise RuntimeError('Fingerprint missing for this dataset. Please run nnUNet_extract_fingerprint')
