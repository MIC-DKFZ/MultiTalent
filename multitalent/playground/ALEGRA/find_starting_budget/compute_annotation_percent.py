...
from multitalent.batch_running.learning_from_sparse_annotations.estimate_annotation_percentages import run_on_folder
...
if __name__ == '__main__':
    ...
    ref_folder = join(nnUNet_preprocessed, ref_name, 'nnUNetPlans_3d_fullres')
    for d in datasets:
        print(d)
        folder = join(nnUNet_preprocessed, maybe_convert_to_dataset_name(d), 'nnUNetPlans_3d_fullres')
