...
def average_probabilities(list_of_files: List[str]) -> np.ndarray:
    ...
    for f in list_of_files:
        if avg is None:
            ...
            avg += np.load(f)['probabilities']
    # maybe_mkdir_p('/home/c306h/E132-Projekte/Projects/2024_Ulrich_Aims_tbi/docker_debug_ensemble')
    # np.save('/home/c306h/E132-Projekte/Projects/2024_Ulrich_Aims_tbi/docker_debug_ensemble/', avg)
    # print('lol')
        ...
        for f in folds:
            ...
            if len(files_here) == 0:
                raise RuntimeError(f"No .npz files found in folder {join(tr, f'fold_{f}', 'validation')}. Rerun your "
                                   f"validation with the --npz flag. Use multitalent_train [...] --val --npz.")
