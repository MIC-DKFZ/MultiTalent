...
from nnunet.training.network_training.nnUNet_variants.transformers.nnUNetTrainerV2_SwinUNETR_ddp import nnUNetTrainerV2_swinunetr_adam_ddp_lr5e4
from nnunet.training.network_training.nnUNet_variants.architectural_variants.nnUNetTrainerV2_ResencUNet_SimonsInit import init_last_bn_before_add_to_0
...
class nnUNetTrainerV2_warmup_increasing_lr(nnUNetTrainerV2):
    ...
    def do_split(self):
        ...
        #self.print_to_log_file(self.dataset_tr)
class nnUNetTrainerV2_warmupsegheads(nnUNetTrainerV2_warmup_increasing_lr):
    ...
    def do_split(self):
        ...
        #self.print_to_log_file(self.dataset_tr)
class nnUNetTrainerV2_warmupsegheads_inpaintreco(nnUNetTrainerV2_warmup_increasing_lr):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
    ...
    def do_split(self):
        ...
        #self.print_to_log_file(self.dataset_tr)
class nnUNetTrainerV2_warmupsegheads_DA5reco(nnUNetTrainerV2_warmup_increasing_lr):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
