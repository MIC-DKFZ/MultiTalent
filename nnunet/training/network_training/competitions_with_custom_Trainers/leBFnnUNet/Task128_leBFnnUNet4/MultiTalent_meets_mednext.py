...
from nnunet.dataset_conversion.Task100_MultiTalent import (
    MultiTalent_regions,
    MultiTalent_region_output_idx_mapping,
...
class Multitalent_mednextt(
    ...
    def __init__(
        ...
        # self.valid_boundaries = np.array(get_boundaries())
